...
//               }
            ...
            System.out.printf("%d번 회원 생생되었습니다%n", id);
            ...
            for (int i = 0; i < members.size(); i++) {
               ...
               System.out.printf("%d  | %s  | %s  |  %s%n", member.id, member.name, member.loginId,
                     member.loginPw);
            }
   ...
   private static void makeTestData() {
      ...
      members.add(new Member(1, "hong1111", "12121212", Util.getRegDate(), "홍길동"));
      members.add(new Member(2, "hong2222", "12121212", Util.getRegDate(), "홍길순"));
      members.add(new Member(3, "hong3333", "12121212", Util.getRegDate(), "홍길영"));
   }
